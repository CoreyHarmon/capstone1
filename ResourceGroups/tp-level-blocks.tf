...
# Create a Storage account in Azure Portal: unique___ with resource group: terraform-storage-rg
# Create a Container in the Sotrage Account: tfstatefiles
# then you will be able to apply this .tf file with Terraform
  backend "azurerm" {
    resource_group_name   = "terraform-storage-rg"
    storage_account_name  = "2024coreyharmon"
